<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-04-15 23:28:00
...
if (!is_callable('smarty_function_laydate')) include 'D:/wamp/www/php/lamp18_Smarty/./myplugins\\function.laydate.php';
...
<br>
<?php echo smarty_function_laydate(array('name' => "start", 'time' => 1, 'value' => ((string)$_smarty_tpl->tpl_vars['ctime']->value)), $_smarty_tpl); ?>
    - <?php echo smarty_function_laydate(array('name' => "end", 'time' => 1), $_smarty_tpl); ?>
<br>
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('textarea', array('name' => "article", 'toolbar' => "desc", 'height' => "300"));
$_block_repeat = true;
echo smarty_block_textarea(array('name' => "article", 'toolbar' => "desc", 'height' => "300"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
    ob_start(); ?>
    <?php $_block_content = ob_get_clean();
    $_block_repeat = false;
    echo smarty_block_textarea(array('name' => "article", 'toolbar' => "desc", 'height' => "300"), $_block_content, $_smarty_tpl, $_block_repeat);
}
